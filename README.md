...
> docker run -it cfloresvv/homework-1

## Nota importante
Para poder acceder a la estructura de archivos establecida (folders numerados con .txts), ejecutar los siguientes comandos una vez dentro del jsh:
> cd ..
